    ...
    void Update (){
        /*if (Input.GetMouseButton(1) && false)
        {
            if (axes == RotationAxes.MouseXAndY)
            {
                ...
                float rotationX = transform.localEulerAngles.y + Input.GetAxis("Mouse X") * Constants.sensitivity;
                rotationY += Input.GetAxis("Mouse Y") * Constants.sensitivity;
            ...
            else if (axes == RotationAxes.MouseX)
            {
                ...
                transform.Rotate(0, Input.GetAxis("Mouse X") * Constants.sensitivity, 0);
